...
public class TestMapPays {
	...
	public static void main(String[] args) {
		...
		// Le put a deux paramètres  : la clé unique et la valeur (ici l'objet Pays)
		...
		// Programme qui demande un nom de pays à un utilisateur, puis qui affiche les info suivantes à l’utilisateur :
	}
